...
- (void)downloadData {
    ...
    //http://iappfree.candou.com:8080/free/applications/sales?currency=rmb&page=%ld
    NSString *urlString = [NSString stringWithFormat:@"http://iappfree.candou.com:8080/free/applications/sales?currency=rmb&page=%ld",self.currentPage];
