...
- (void)downloadData {
    ...
    //http://iappfree.candou.com:8080/free/applications/free?currency=rmb&page=%ld
    NSString *urlString = [NSString stringWithFormat:@"http://iappfree.candou.com:8080/free/applications/free?currency=rmb&page=%ld",self.currentPage];
